...
//   return (
//     <div ref={ref}>
//       <h3 className="font-sans-flex text-primary text-5xl font-light xl:text-6xl 2xl:text-[80px]">
  ...
  return (
    <section className="overflow-hidden bg-white-blue py-16 xl:py-24 text-center lg:text-left">
      <Container size="lg">
        ...
        <div className="grid gap-10 lg:grid-cols-[400px_1fr] items-center">
          <div className="lg:order-2 lg:pl-20">
            <Heading className="text-white-blue" variant="xxl">
              <span className="lg:block text-primary font-bold max-w-150">{data.title.highlight} </span>
              <span className="lg:block text-secondary">{data.title.text}</span>
            </Heading>
            <Button href="/about-us" rounded="full" arrow arrowStyle="circle" className="pr-1 mt-8">
              Learn More
            </Button>
          </div>
